...
def letter_grades(highest):
    ...
    assert highest > 40 # otherwise the instruction doesn't make sense
    # F = 40
    # A = highest
    # E = 41
    # B, C, D, E: only interesting, and E is given
...
def perfect_score(student_info):
    ...
    """
    return next(([n, s] for n, s in student_info if s == 100), 'No perfect score.')
