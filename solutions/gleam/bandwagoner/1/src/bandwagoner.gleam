...
let wins = team.stats.wins // TODO can I do this inline - how?
let losses = team.stats.losses // TODO can I do this inline - how?
  case team, wins, losses {
Team(coach: Coach(name: "Gregg Popovich", ..), ..), w, l
| Team(coach: Coach(former_player: True, ..), ..), w, l
| Team(name: "Chicago Bulls", ..), w, l -> True
_, w, l if w >= 60 || l > w -> True 
_, _, _ -> False
  }
}
